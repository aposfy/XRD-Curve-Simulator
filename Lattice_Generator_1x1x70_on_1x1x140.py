...
class MgO_lattice:
    def __init__(self, lattice_i, lattice_j, lattice_k):
        ...
        self.lattice_0x=lattice_i*a
        self.lattice_0y=lattice_j*a
        self.lattice_0z=lattice_k*a+70*a
...
all_BaZrO3_lattice=[[[BaZrO3_lattice(i,j,k) for k in range(0,70)]for j in range(0,1)]for i in range(0,1)]
'''print (all_BaZrO3_lattice[20][20][5].lattice_0z)'''
# An array containing all the MgO lattice   
all_MgO_lattice=[[[MgO_lattice(i,j,k) for k in range(0,140)]for j in range(0,1)]for i in range(0,1)]
...
for i in range(0,1):
    for j in range(0,1):
        for k in range(0,70):
            if (i+j+k)%2==0:
                all_BaZrO3_lattice[i][j][k].O1_atom.z=all_BaZrO3_lattice[i][j][k].O1_atom.z+0.35
                all_BaZrO3_lattice[i][j][k].O3_atom.x=all_BaZrO3_lattice[i][j][k].O3_atom.x+0.35
